...
class SettingsRepository(context: Context) {
    ...
    fun showMetadataInMarkdown(): Boolean =
        preferences.getBoolean("show_metadata_in_md", false)

    fun sortOrder(): String =
        preferences.getString("sort_order", "name") ?: "name"

    fun notificationOnScanComplete(): Boolean =
        preferences.getBoolean("notification_on_scan_complete", true)
}
