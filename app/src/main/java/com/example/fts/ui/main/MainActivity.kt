...
class MainActivity : AppCompatActivity() {
    ...
    private fun onFolderSelected(uri: Uri) {
        ...
        if ((viewModel.rootFolders.value?.size ?: 0) >= Constants.MAX_FOLDERS) { Toast.makeText(this, "Chỉ được tối đa ${Constants.MAX_FOLDERS} thư mục", Toast.LENGTH_SHORT).show(); return }
